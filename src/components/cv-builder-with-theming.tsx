...
export function CvBuilderWithTheming() {
  const [cvData, setCVData] = useState<CVData>({
    ...
    experience: [
      {
        ...
        description: [
          "Lead a team of 5 developers in the design and implementation of new features",
          "Improved system performance by 35% through code optimization",
          "Implemented automated testing, increasing code coverage by 50%",
        ],
      },
      {
        company: "DataCorp",
    ...
    keyProjects: [
      "Developed a real-time analytics dashboard, increasing client satisfaction by 40%",
      "Led the migration of legacy systems to cloud infrastructure, reducing operational costs by 25%",
      "Created a mobile app for internal use, improving team productivity by 20%",
    ],
    certificates: [
    ...
    tools: ["Git", "Docker", "Jenkins", "Jira", "Kubernetes"],
    education: [
      {
